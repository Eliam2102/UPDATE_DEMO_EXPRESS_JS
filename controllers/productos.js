...
const productos = [
    { id: 1, nombre: 'Funko POP Jujutsu Kaisen Sukuna', descripcion: 'Todos nuestros Funkos son originales, nuevos y mint condition.', cantidad: 10, precio: 1900, imagen: 'producto1.jpgs' },
    ...
    { id: 8, nombre: 'Producto 8', descripcion: 'Descripción del Producto 7', cantidad: 5, precio: 50, imagen: 'producto7.jpg' }
  ];
